...
{
    public partial class Initial_Receipt : Form
    {
        ...
        public Initial_Receipt(int currentUserId, int currentDepartmentId, int currentOrganizationId)
        {
            InitializeComponent();
        ...
        private void Initial_Receipt_Load(object sender, EventArgs e)
        {
